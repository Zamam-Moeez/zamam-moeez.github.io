            ...
            <PopoverTrigger>
              <Link
                ...
                onClick={(e) => {
                  ...
                  const section = document.querySelector(navItem.href);
                  if (section) {
                    const headerHeight = 60; // Adjust this if the header height changes
                    const offsetTop = section.offsetTop - headerHeight; // Calculate offset
                    window.scrollTo({ top: offsetTop, behavior: 'smooth' }); // Smooth scroll to section
                  }
                }}
              >
                {navItem.label}
